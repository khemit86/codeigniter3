    ...
    <div class="wrapper">
        <div class="crumb">
            ...
            <ul class="breadcrumb">
                ...
                <li class="active"><a href="<?= base_url() ?>projects_disputes/auto_closed_projects_disputes_listing">Auto Closed Disputes List</a></li>
            </ul>
        </div>
        ...
        <div class="container-fluid">
            <div id="heading" class="page-header">
                <h1><i class="icon20 i-table-2"></i> Disputes Management (Auto Closed)</h1>
            </div>
            <div class="row">
                ...
                <div class="col-lg-12">
        			...
        			<div class="col-lg-12">
						 ...
						 <form id="validate" action="<?php echo base_url(); ?>projects_disputes/auto_closed_projects_disputes_listing" class="form-horizontal" role="form" name="state" method="get" enctype="multipart/form-data">
