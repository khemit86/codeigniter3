    ...
    <div class="wrapper">
        <div class="crumb">
            ...
            <ul class="breadcrumb">
                ...
                <li class="active"><a href="<?= base_url() ?>projects_disputes/active_projects_disputes_listing">Active Disputes List</a></li>
            </ul>
        </div>
        ...
        <div class="container-fluid">
            <div id="heading" class="page-header">
                <h1><i class="icon20 i-table-2"></i> Disputes Management (Active)</h1>
            </div>
            <div class="row">
                ...
                <div class="col-lg-12">
        			...
        			<div class="col-lg-12">
						 ...
						 <form id="validate" action="<?php echo base_url(); ?>projects_disputes/active_projects_disputes_listing" class="form-horizontal" role="form" name="state" method="get" enctype="multipart/form-data">
                    ...
                    <table class="table table-hover table-bordered adminmenu_list" id="example1">
                        <thead>
                            <tr>
								...
								<!--<th style="text-align:left;" width="5%">Escrow Amount</th>-->
                                ...
                                foreach ($projects_disputes_listing as $key => $val) {
                                   ...
                                   ?>
                                    ...
                                    <tr>  
										...
										<?php
										/* <td><?php 
										//echo $val['project_type']; 	
										$get_sum_escrow_disputed_projects = get_sum_escrow_disputed_projects($val['project_type'],array('dispute_reference_id'=>$val['dispute_reference_id']));
										echo str_replace(".00","",$get_sum_escrow_disputed_projects['total_disputed_escrow']). " ". CURRENCY;
