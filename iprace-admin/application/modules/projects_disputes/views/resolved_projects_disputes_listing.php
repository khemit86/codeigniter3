    ...
    <div class="wrapper">
        <div class="crumb">
            ...
            <ul class="breadcrumb">
                ...
                <li class="active"><a href="<?= base_url() ?>projects_disputes/resolved_projects_disputes_listing">Resolved Disputes List</a></li>
            </ul>
        </div>
        ...
        <div class="container-fluid">
            <div id="heading" class="page-header">
                <h1><i class="icon20 i-table-2"></i> Disputes Management (Resolved)</h1>
            </div>
            <div class="row">
                ...
                <div class="col-lg-12">
        			...
        			<div class="col-lg-12">
						 ...
						 <form id="validate" action="<?php echo base_url(); ?>projects_disputes/resolved_projects_disputes_listing" class="form-horizontal" role="form" name="state" method="get" enctype="multipart/form-data">
                    ...
                    <table class="table table-hover table-bordered adminmenu_list" id="example1">
                        <thead>
                            <tr>
								...
								<th style="text-align:left;">Dispute End date</th>
								<th style="text-align:left;" width="5%">Dispute Winner</th>
                                   ...
                                   ?>
                                    ...
                                    <tr>  
                                        ...
                                        <td><?= date(DATE_TIME_FORMAT_EXCLUDE_SECOND,strtotime($val['dispute_start_date'])) ?></td>
										 <td><?= date(DATE_TIME_FORMAT_EXCLUDE_SECOND,strtotime($val['dispute_end_date'])) ?></td>
										 <td><?php 
										 if($val['dispute_status'] == 'admin_decision'){
											$dispute_winner_user_name = $val['dispute_winner_account_type'] == USER_PERSONAL_ACCOUNT_TYPE ? $val['dispute_winner_first_name'] . ' ' . $val['dispute_winner_last_name'] : $val['dispute_winner_company_name'];
											echo $dispute_winner_user_name;
										 }else{
											echo "-";
										 }				
										?></td>
										  <td><?php
										  if($val['dispute_status'] == 'parties_agreement'){
											 echo "users agreement (accepted counter offer) ";
										  }
										  if($val['dispute_status'] == 'admin_decision'){
											 echo "admin decision";
										  }
										  if($val['dispute_status'] == 'dispute_cancelled_by_initiator_po' || $val['dispute_status'] == 'dispute_cancelled_by_initiator_sp' || $val['dispute_status'] == 'dispute_cancelled_by_initiator_employer' || $val['dispute_status'] == 'dispute_cancelled_by_initiator_employee'){
											 echo "closed by initiator";
										  }
