                    ...
                    <div class="panel panel-default">
						...
						<div class="panel-inner">
							...
							<div class="project-attachments">
								...
								<ul><?php
									foreach($project_attachment_data as $project_attachment_key=>$project_attachment_value){
										...
										$download_url = base_url()."project/download_project_attachment/".$attachment_id."/".$project_data[0]['profile_name']."/awarded";
							...
							<div class="bottom-btn text-center">
								<a href="<?php echo base_url(); ?>project/awarded" class="btn btn-primary">Back</a>
							</div>
						</div>
