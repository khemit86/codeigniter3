    ...
    <div class="wrapper">
        ...
        <div class="container-fluid">
            <div id="heading" class="page-header">
                <h1><i class="icon20 i-table-2"></i> Project Management (Awaiting Moderation)</h1>
            </div>
            <div class="row">
              <div class="col-lg-12">
                <!-- End .form-group  -->
            ...
            <div class="row">
                ...
                <div class="col-lg-12">
                    ...
                    <div class="member_wrapper">
                        <?php echo $this->load->view('ajax_awaiting_approval_project_list', ['project_listing' => $project_listing, 'links' => $links, 'total_rows' => $total_rows], TRUE); ?>
                    </div>
...
<script src="<?php echo JS; ?>modules/awaiting_approval_project.js" type="text/javascript"></script>
