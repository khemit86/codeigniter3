                    ...
                    <div class="panel panel-default">
						...
						<div class="panel-inner">
							...
							<div class="Project-details">
								...
								<li>
									<p>
										<strong>project cancellation date:</strong>
										<?php
										echo $project_data[0]['project_cancellation_date']; 
										?>
									</p>
								</li>
								<?php
							...
							<div class="project-upgrade">
								...
								<ul>
									<li>
										<?php
										if(!empty($project_data[0]['featured']) && $project_data[0]['featured'] == 'Y'){
											echo '<span>Featured</span>';
										}if(!empty($project_data[0]['urgent']) && $project_data[0]['urgent'] == 'Y'){
											echo '<span>Urgent</span>';
										}
										if(!empty($project_data[0]['sealed']) && $project_data[0]['sealed'] == 'Y'){
											echo '<span>Sealed</span>';
										}
										if(!empty($project_data[0]['hidden']) && $project_data[0]['hidden'] == 'Y'){
							...
							<div class="project-attachments">
								...
								<ul><?php
									foreach($project_attachment_data as $project_attachment_key=>$project_attachment_value){
										...
										$download_url = base_url()."project/download_project_attachment/".$attachment_id."/".$project_data[0]['profile_name']."/expire";
							...
							<div class="bottom-btn text-center">
								<a href="<?php echo base_url(); ?>project/canceled" class="btn btn-primary">Back</a>
							</div>
						</div>
