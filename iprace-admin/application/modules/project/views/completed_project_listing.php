    ...
    <div class="wrapper">
        ...
        <div class="container-fluid">
            <div id="heading" class="page-header">
                <h1><i class="icon20 i-table-2"></i> Project Management (Completed)</h1>
            </div>
            ...
            <div class="row">
                ...
                <div class="member_wrapper">
                    <?php echo $this->load->view('ajax_completed_project_list', ['project_listing' => $project_listing, 'links' => $links, 'total_rows' => $total_rows], TRUE); ?>
                </div>
...
<script src="<?php echo JS; ?>modules/completed_project.js" type="text/javascript"></script>
