                    ...
                    <table class="table table-hover table-bordered adminmenu_list" id="example1">
                        <thead>
                            <tr>
                                ...
                                <th style="text-align:left;">cancellation date</th>
                            ...
                            if (count($project_listing) > 0) { 
                                foreach ($project_listing as $key => $val) {
                                    ...
                                    <tr>  
                                        ...
                                        <td><?= date(DATE_TIME_FORMAT,strtotime($val['project_cancellation_date'])) ?></td>
                                        <td align="center" id="ac">
											...
											?>
											<a class="btn btn-danger" href="<?php echo base_url(); ?>project/delete_canceled_project/<?php echo $val['project_id']; ?>">Delete</a>
											<?php
												}
											}else{	
											?>
