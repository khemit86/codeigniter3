                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            ...
                            <h4>Project Detail (Awaiting Moderation)</h4>
						...
						<div class="panel-inner">
							...
							<div class="tags-list">
								<ul> 
									...
									?>
										<li> <span><?php echo $project_tag_value['awaiting_moderation_project_tag_name'] ?></span></li>
									<?php
									}
									?>
								</ul>
							...
							<div class="project-attachments">
								...
								<ul><?php
									foreach($project_attachment_data as $project_attachment_key=>$project_attachment_value){
										...
										$download_url = base_url()."project/download_project_attachment/".$attachment_id."/".$project_data[0]['profile_name']."/awaiting_moderation";
							...
							<div class="bottom-btn text-center">
								<a href="<?php echo base_url(); ?>project/approved_awaiting_moderation_project/<?php echo $project_data[0]['project_id']; ?>" class="btn btn-info">Approve</a>
								<a href="<?php echo base_url(); ?>project/rejected_awaiting_moderation_project/<?php echo $project_data[0]['project_id']; ?>" class="btn btn-info">Reject</a>
								<a href="<?php echo base_url(); ?>project/awaiting_approval" class="btn btn-primary">Back</a>
							</div>
						</div>
