                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            ...
                            <h4>Project Detail (Open For Bidding)</h4>
						...
						<div class="panel-inner">
							...
							<div class="project-attachments">
								...
								<ul><?php
									foreach($project_attachment_data as $project_attachment_key=>$project_attachment_value){
										...
										$download_url = base_url()."project/download_project_attachment/".$attachment_id."/".$project_data[0]['profile_name']."/open_for_bidding";
							...
							<div class="bottom-btn text-center">
								<a href="<?php echo base_url(); ?>project/open_for_bidding" class="btn btn-primary">Back</a>
							</div>
						</div>
