                                    ...
                                    <tr>  
                                        ...
                                        <td width="5%">
											...
											if($val['account_type'] == USER_PERSONAL_ACCOUNT_TYPE){
                                                ...
                                                if($val['is_authorized_physical_person'] == 'Y'){
                                                    echo ucwords($val['first_name']." ".$val['last_name']);
                                                }else{
                                        ...
                                        <td align="center" id="ac">
											...
											?>
												<a class="btn btn-danger" href="<?php echo base_url(); ?>project/delete_open_for_bidding_project/<?php echo $val['project_id']."?per_page=".$this->input->get('per_page'); ?>">Delete</a>
												<a class="btn btn-danger" href="<?php echo base_url(); ?>project/cancel_open_for_bidding_project/<?php echo $val['project_id']."?per_page=".$this->input->get('per_page'); ?>">Cancel</a>
											<?php
												}
											}else{
											?>
