                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            ...
                            <h4>Project Detail (Completed)</h4>
							...
							<div class="Project-details">
								...
								<li>
									<p>
										...
										<?php echo $project_data[0]['project_completion_date']; ?>
									</p>
								</li>
								</ul>
							</div>
							...
							<div class="project-attachments">
								...
								<ul><?php
									foreach($project_attachment_data as $project_attachment_key=>$project_attachment_value){
										...
										$download_url = base_url()."project/download_project_attachment/".$attachment_id."/".$project_data[0]['profile_name']."/completed";
