    ...
    <div class="wrapper">
        ...
        <div class="container-fluid">
            <div id="heading" class="page-header">
                <h1><i class="icon20 i-table-2"></i> Project Management (Open For Bidding)</h1>
            </div>
            <div class="row">
              <div class="col-lg-12">
                <!-- End .form-group  -->
            ...
            <div class="row">
                ...
                <div class="col-lg-12">
                  ...
                  <div class="member_wrapper">
                    <?php echo $this->load->view('ajax_open_for_bidding_project_list', ['project_listing' => $project_listing, 'links' => $links, 'total_rows' => $total_rows], TRUE); ?>
                  </div>
...
<script src="<?php echo JS; ?>modules/open_for_bidding_project.js" type="text/javascript"></script>