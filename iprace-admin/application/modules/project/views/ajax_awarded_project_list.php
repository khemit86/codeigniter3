                    ...
                    <table class="table table-hover table-bordered adminmenu_list" id="example1">
                        <thead>
                            <tr>
                                ...
                                <th style="text-align:left;">Project Owner</th>
                                ...
                                foreach ($project_listing as $key => $val) {
                                    ...
                                    <tr>  
                                        ...
                                        <td align="center" id="ac">
											<a class="btn btn-danger" href="<?php echo base_url(); ?>project/cancel_awarded_project/<?php echo $val['project_id']; ?>">Cancel</a>
                                        </td>
