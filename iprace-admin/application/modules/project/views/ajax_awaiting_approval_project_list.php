                        ...
                        <table class="table table-hover table-bordered adminmenu_list" id="example1">
                            <thead>
                                <tr>
                                    ...
                                    <th style="text-align:left;">Submit to Approval Date</th>
                                    <th style="text-align:left;">Auto Approval Date</th>
                                ...
                                if (count($project_listing) > 0) { 
                                    foreach ($project_listing as $key => $val) {
                                        ...
                                        <tr>  
                                            ...
                                            <td><?= date(DATE_TIME_FORMAT,strtotime($val['project_submission_to_moderation_date'])) ?></td>
                                            <td><?= date(DATE_TIME_FORMAT,strtotime($val['auto_approval_date'])) ?></td>
                                    
                                            <td align="center" id="ac">
                                                <a class="btn btn-danger" href="<?php echo base_url(); ?>project/approved_awaiting_moderation_project/<?php echo $val['project_id']; ?>">Approve</a>
                                                <!--<a class="btn btn-danger appProFromAwaMod" href="javascript:;">Approve</a>-->
                                                <a class="btn btn-danger" href="<?php echo base_url(); ?>project/rejected_awaiting_moderation_project/<?php echo $val['project_id']; ?>">Reject</a>
                                                <a class="btn btn-danger" href="<?php echo base_url(); ?>project/delete_awaiting_moderation_project/<?php echo $val['project_id']; ?>">Delete</a>
                                            </td>
