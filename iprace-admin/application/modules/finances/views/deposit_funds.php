    ...
    <div class="wrapper">
        <div class="crumb">
            ...
            <ul class="breadcrumb">
                ...
                <li class="active"><a href="<?= base_url() ?>finances/deposit_funds">Deposit Funds</a></li>
            </ul>
        </div>
        ...
        <div class="container-fluid">
            <div id="heading" class="page-header">
                <h1><i class="icon20 i-table-2"></i> Deposit Funds</h1>
            </div>
            <div class="row">
                   ...
                   <table class="table table-hover table-bordered adminmenu_list" id="example1">
                        <thead>
                            <tr>
                                ...
                                <th style="text-align:left;">Deposited Date</th>
                                <th style="text-align:left;">Available Funds</th>
                            </tr>
                        </thead>
                        <tbody>
                            <div id="prodlist">
                              ...
                              <tr>
                                    ...
                                    <td>
                                        <?php echo ucwords($val['transaction_source']); ?>
                                    </td>
                                    <td>
                                        <?php echo format_money_amount_display($val['deposit_amount']).' '.CURRENCY; ?>
                                    </td>
                                    <td>
                                        <?php echo date(DATE_TIME_FORMAT, strtotime($val['transaction_date'])); ?>
                                    </td>
                                    <td>
                                        <?php echo $val['account_available_funds'].' '.CURRENCY; ?>
                                    </td>
                              </tr>
                              <?php    
                                  }
