    ...
    <div class="wrapper">
        <div class="crumb">
            <ul class="breadcrumb">
                ...
                <li class="active">Modify Category</a></li>
            </ul>
        </div>

        <div class="container-fluid">
            <div id="heading" class="page-header">
                <h1><i class="icon20 i-list-4"></i> Add/Modify Category </h1>
            </div>
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            ...
                            <h4>Add/Modify Category</h4>
                            <a href="#" class="minimize2"></a>
                        </div><!-- End .panel-heading -->

                        <div class="panel-body">
                        	<?php echo validation_errors('<div class=" red alert ">', '</div>'); ?>
                            <form id="validate" action="<?php echo base_url(); ?>categories_projects/edit/" class="form-horizontal" role="form" name="adminmenu" method="post">
