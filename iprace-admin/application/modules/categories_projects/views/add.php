<section id="content">
    <div class="wrapper">
        <div class="crumb">
            ...
            <li class="active">Add New Category</a></li>
            </ul>
        </div>

        <div class="container-fluid">
            <div id="heading" class="page-header">
                <h1><i class="icon20 i-list-4"></i> Add/Modify Project Category </h1>
            </div>
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            ...
                            <h4>Add/Modify Project Category</h4>
                        ...
                        <div class="panel-body"> 
                            ...
                            <form id="validate" action="<?php echo base_url(); ?>categories_projects/add" class="form-horizontal" role="form" name="adminmenu" method="post">
                                ...
                                if ($p_id != '') {
                                    $p_name = $this->auto_model->getFeild('name', 'categories_projects', 'id', $p_id);
                                    ?>  
                                ...
                                <div class="form-group">
                                    <div class="col-lg-offset-2">
                                        <div class="pad-left15">
                                            ...
                                            <button type="button" onclick="redirect_to('<?php echo base_url() . 'categories_projects/'; ?>');" class="btn">Cancel</button>
                                        </div>
                                    </div>
                                </div><!-- End .form-group  -->
