    ...
    <div class="wrapper">
        <div class="crumb">
            <ul class="breadcrumb">
               ...
               <li class="active"><a onclick="redirect_to('<?php echo base_url() . 'categories_professionals'; ?>');">Talents Sub-category list</a> </li>
            <li class="active">Add New Talents Sub-category</a></li>
            </ul>
        </div>

        <div class="container-fluid">
            <div id="heading" class="page-header">
                <h1><i class="icon20 i-list-4"></i> Add/Modify Project Talents Sub-category </h1>
            </div>
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            ...
                            <h4>Add/Modify Project Talents Sub-category</h4>
                        ...
                        <div class="panel-body"> 
                            ...
                            <form id="validate" action="<?php echo base_url(); ?>categories_professionals/add_subcategory" class="form-horizontal" role="form" name="adminmenu" method="post">
                                ...
                                <div class="form-group">
                                    <div class="col-lg-offset-2">
                                        <div class="pad-left15">
                                            ...
                                            <button type="button" onclick="redirect_to('<?php echo base_url() . 'categoriestalents/subcategories'; ?>');" class="btn">Cancel</button>
                                        </div>
                                    </div>
                                </div><!-- End .form-group  -->
