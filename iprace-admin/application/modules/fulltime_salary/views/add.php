<section id="content">
    <div class="wrapper">
        <div class="crumb">
            ...
            <li class="active">Add Fulltime Salary</a></li>
            </ul>
        </div>
        ...
        <div class="container-fluid">
            <div id="heading" class="page-header">
                <h1><i class="icon20 i-list-4"></i> Add Fulltime Salary </h1>
            </div>
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body"> 
                            ...
                            <form id="validate" action="<?php echo base_url(); ?>fulltime_salary/add" class="form-horizontal" role="form" name="fixedbudget" method="post">
