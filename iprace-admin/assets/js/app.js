...
$(document).ready(function () {
    ...
    $('ul.show').parents('.main_active').find('.notExpand').removeClass('notExpand rotateOut').addClass('expand');
    $('ul.show').parents('.main_active').find('.expand').find('span.more i').removeClass('i-arrow-down-2').addClass('i-arrow-up-2');
    ...
    if (typeof action != 'undefined' && !['category-mapping', 'member', 'project'].includes(action)) {
        try {
