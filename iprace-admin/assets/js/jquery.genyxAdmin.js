...
; (function ($) {
    ...
    $.fn.genyxAdmin = function (options) {
        ...
        function mainNav() {
            ...
            navLink.on("click", function () {
                ...
                if (_this.hasClass('notExpand')) {
                    ...
                    _this.next('ul').slideUp(250, function () {
        ...
        function hoverDropDown(val) {
            (function (e, t, n) {
                e('<span class="visible-desktop" style="font-size:1px !important" id="vis">.</span>').appendTo("body"); var r = function () { return e("#vis").is(":visible") }, i = e(); e.fn.dropdownHover = function (n) {
                    i = i.add(this.parent()); return this.each(function () {
                        var s = e(this).parent(), o = { delay: 500, instantlyCloseOthers: !0 }, u = { delay: e(this).data("delay"), instantlyCloseOthers: e(this).data("close-others") }, a = e.extend(!0, {}, o, n, u), f; s.hover(function () {
                            if (r()) {
                                a.instantlyCloseOthers === !0 && i.removeClass("open");
                                t.clearTimeout(f); e(this).addClass("open")
                            }
                        }, function () { r() && (f = t.setTimeout(function () { s.removeClass("open") }, a.delay)) })
                    })
                }; e(document).ready(function () { e('[data-hover="dropdown"]').dropdownHover() })
            })(jQuery, this); $(".dropdown-toggle").dropdownHover({ delay: val });
        }
