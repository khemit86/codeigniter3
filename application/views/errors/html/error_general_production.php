		...
		<div class="row">
			<div class="col-md-12 col-sm-12 col-12">
				<div class="error_body_sectn">
					...
					<h3><?php echo $CI->config->item('system_generated_404_page_message'); ?> (err kod: g574P00olqWN)</h3>
...
<script>
	$(document).ready(function () {
		...
		var bHeight = wheight - (parseInt($("#headerContent").outerHeight())+parseInt($("#errorFooter").outerHeight())+3);
