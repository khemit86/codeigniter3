...
<div class="feedbackBtn">
		...
		<?php
		if($check_receiver_received_rating == 1 && $check_receiver_view_his_rating == 0){
		?>
		<div class="default_blank_message"><?php echo $other_party_given_feedback_msg; ?></div>	
		<?php
		}
		
		if($check_receiver_received_rating == 0){
		?>
			<div class="default_blank_message"><?php echo $other_party_not_given_feedback_msg; ?></div>	
		<?php
...
<?php
if(!empty($feedback_data) && $check_receiver_view_his_rating == 1 ){	
?>	
<div>
	<!--<div class="fcd">-->
		<div class="row">
		...
		?>
			...
			<div class="row">
				...
				<div class="col-md-5 col-sm-5 col-12 ratingLeft">
						<div class="ratingDiv">
								...
								<div class="rRating">
									<div class="sRate">
										<small>
											<?php echo show_dynamic_rating_stars($feedback_data['clarity_in_requirements']); ?>
										</small>
						...
						<div class="ratingDiv">
							...
							<div class="rRating">
								<div class="sRate">
									<small>
										<?php echo show_dynamic_rating_stars($feedback_data['communication']); ?>
									</small>
						...
						<div class="ratingDiv">
							...
							<div class="rRating">
								<div class="sRate">
									<small>
										<?php echo show_dynamic_rating_stars($feedback_data['payment_promptness']); ?>
									</small>
				...
				<div class="col-md-5 col-sm-5 col-12 ratingRight">
					...
					<div class="responseDiv">
						<div class="workText">
							<span class="default_black_bold"><?php //echo str_replace(array('{user_first_name_or_company_name}'),array($po_name),$this->config->item('projects_users_ratings_feedbacks_would_you_recommend_po_sp_view')); ?>
								<?php
								if(($po_account_type == USER_PERSONAL_ACCOUNT_TYPE) || ($po_account_type == USER_COMPANY_ACCOUNT_TYPE && $po_is_authorized_physical_person == 'Y')){
									if($po_is_authorized_physical_person == 'Y'){
										if($po_gender =='M' ){
				...
				<div class="col-md-5 col-sm-5 col-12 ratingRight">											
					...
					<div class="responseDiv">
						<div class="workText">
							...
							<span class="default_black_bold"><?php echo str_replace(array('{user_first_name_or_company_name}'),array($sp_first_name),$this->config->item('projects_users_ratings_feedbacks_would_you_hire_sp_again_po_view')); ?></span>
						</div>
						<div class="responseText">
					...
					<div class="responseDiv">
						<div class="workText">
							<span class="default_black_bold"><?php echo str_replace(array('{user_first_name_or_company_name}'),array($sp_first_name),$this->config->item('projects_users_ratings_feedbacks_would_you_recommend_sp_po_view')); ?></span>
						</div>
						<div class="responseText">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-5 col-sm-5 col-12 ratingRight">
                                ...
                                <div class="responseDiv">
                                    ...
                                    <div class="responseText">
                                        <span class="default_black_regular"><?php echo $feedback_data['would_you_recommend_sp'] == 'Y' ? $this->config->item('projects_users_ratings_feedbacks_radio_button_label_yes') : $this->config->item('projects_users_ratings_feedbacks_radio_button_label_no'); ?></span>
                                    </div>
                                    <div class="clearfix"></div>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-5 col-sm-5 col-12 ratingLeft">
                                <div class="ratingDiv">
                                    ...
                                    <div class="rRating">
                                        <div class="sRate">
                                            <small><?php echo show_dynamic_rating_stars($feedback_data['work_life_balance']); ?></small>
                                ...
                                <div class="ratingDiv">
                                    ...
                                    <div class="rRating">
                                        <div class="sRate">
                                            <small><?php echo show_dynamic_rating_stars($feedback_data['career_opportunities']); ?></small>
                                ...
                                <div class="ratingDiv">
                                    ...
                                    <div class="rRating">
                                        <div class="sRate">
                                            <small><?php echo show_dynamic_rating_stars($feedback_data['compensation_benefits']); ?></small>
                                ...
                                <div class="ratingDiv">
                                    ...
                                    <div class="rRating">
                                        <div class="sRate">
                                            <small><?php echo show_dynamic_rating_stars($feedback_data['proper_training_support_mentorship_leadership']); ?></small>
                                ...
                                <div class="ratingDiv">
                                    ...
                                    <div class="rRating">
                                        <div class="sRate">
                                            <small><?php echo show_dynamic_rating_stars($feedback_data['explained_job_responsibilities_expectation']); ?></small>
                                ...
                                <div class="ratingDiv">
                                    ...
                                    <div class="rRating">
                                        <div class="sRate">
                                            <small><?php echo show_dynamic_rating_stars($feedback_data['environment_encourages_expressing_sharing_ideas_innovation']); ?></small>
                                ...
                                <div class="ratingDiv">
                                    ...
                                    <div class="rRating">
                                        <div class="sRate">
                                            <small><?php echo show_dynamic_rating_stars($feedback_data['safe_healthy_environment']); ?></small>
                            ...
                            <div class="col-md-5 col-sm-5 col-12 ratingLeft">
                                <div class="ratingDiv">
                                    ...
                                    <div class="rRating">
                                        <div class="sRate">
                                            <small>
                                                <?php echo show_dynamic_rating_stars($feedback_data['demonstrates_effective_oral_verbal_communication_skills']); ?>
                                            </small>
                                ...
                                <div class="ratingDiv">
                                    ...
                                    <div class="rRating">
                                        <div class="sRate">
                                            <small>
                                                <?php echo show_dynamic_rating_stars($feedback_data['work_quality']); ?>
                                            </small>
                                ...
                                <div class="ratingDiv">
                                    ...
                                    <div class="rRating">
                                        <div class="sRate">
                                            <small>
                                                <?php echo show_dynamic_rating_stars($feedback_data['self_motivated']); ?>
                                            </small>
                                ...
                                <div class="ratingDiv">
                                    ...
                                    <div class="rRating">
                                        <div class="sRate">
                                            <small>
                                                <?php echo show_dynamic_rating_stars($feedback_data['working_relations']); ?>
                                            </small>
                                ...
                                <div class="ratingDiv">
                                    ...
                                    <div class="rRating">
                                        <div class="sRate">
                                            <small>
                                                <?php echo show_dynamic_rating_stars($feedback_data['demonstrates_flexibility_adaptability']); ?>
                                            </small>
                                ...
                                <div class="ratingDiv">
                                    ...
                                    <div class="rRating">
                                        <div class="sRate">
                                            <small>
                                                <?php echo show_dynamic_rating_stars($feedback_data['solves_problems']); ?>
                                            </small>
                                ...
                                <div class="ratingDiv">
                                    ...
                                    <div class="rRating">
                                        <div class="sRate">
                                            <small>
                                                <?php echo show_dynamic_rating_stars($feedback_data['work_ethic']); ?>
                                            </small>
