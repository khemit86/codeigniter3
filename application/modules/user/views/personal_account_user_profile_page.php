...
<div class="dashTop">
	...
	<div class="profSecond userProfileAdjust">
		<div class="row">
							...
							<span id="user_info_section" class="onLName default_user_name onAdd <?php echo $user_info_section_class; ?>">
								...
								<span id="cover_picture_button_section" class="projBtn <?php echo $cover_picture_button_class; ?>">
									...
									<div class="onlCont_btn">
										...
										<?php /* <button id="edit_cover_picture" style="<?php echo  $user_cover_picture_exist_status ? '' : 'display:none' ?>" type="button" class="btn default_btn blue_btn"><?php echo $this->config->item('edit_btn_txt'); ?></button> */ ?>
									...
									<?php } else { ?>
										...
										?>
										<div class="onlCont">
											<button class="btn default_btn green_btn" data-profile-name="<?php echo $user_detail['profile_name']; ?>" data-gender="<?php echo $user_detail['gender']; ?>" data-name="<?php echo $user_detail['account_type'] == 1 ? $user_detail['first_name'].' '.$user_detail['last_name'] : $user_detail['company_name']; ?>" data-id="<?php echo $user_detail['user_id']; ?>" data-profile-pic="<?php echo $user_profile_picture;?>" data-is-in-contact="<?php echo !empty($is_in_contact) ? $is_in_contact : ''; ?>" id="contactMe"><?php echo $this->config->item('contactme_button'); ?></button>
										</div>
										<?php
