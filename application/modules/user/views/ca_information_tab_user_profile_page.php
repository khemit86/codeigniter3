...
if($user_detail['account_type'] == USER_COMPANY_ACCOUNT_TYPE && $user_detail['is_authorized_physical_person'] == 'Y'){
	if(empty($user_detail['description']) && empty($company_base_information['company_vision']) && empty($company_base_information['company_mission']) && empty($company_base_information['company_core_values']) && empty($company_base_information['company_strategy_goals']) && empty($user_skills_data) && empty($areas_of_expertise) && empty($user_services_data) && empty($user_work_experience_data) && empty($user_education_training_data) && empty($language_name) && empty($user_spoken_languages_data) && empty($user_certifications_data) && empty($recordArr)){
		if($this->session->userdata('user') && $user[0]->user_id == $user_detail['user_id']){
			...
			$user_name = ($user_detail['account_type'] == USER_COMPANY_ACCOUNT_TYPE && $user_detail['is_authorized_physical_person'] == 'Y')?$user_detail['first_name'] . ' ' . $user_detail['last_name']:$user_detail['company_name'];
			
			
			if($user_detail['account_type'] == USER_COMPANY_ACCOUNT_TYPE && $user_detail['is_authorized_physical_person'] == 'Y'){
				if($user_detail['gender'] == 'M'){
				  $no_data_msg = $this->config->item('user_profile_page_information_tab_no_data_company_app_male_visitor_view');
				} else if($user_detail['gender'] == 'F'){
				  $no_data_msg = $this->config->item('user_profile_page_information_tab_no_data_company_app_female_visitor_view');
				}
				$no_data_msg = str_replace(array('{user_first_name_last_name}'),array($user_name),$no_data_msg);
			}else{
				
				$no_data_msg = $this->config->item('user_profile_page_information_tab_no_data_company_visitor_view');
				$no_data_msg = str_replace(array('{user_company_name}'),array($user_name),$no_data_msg);
			}
	...
	if(empty($user_detail['description']) && empty($company_base_information['company_vision']) && empty($company_base_information['company_mission']) && empty($company_base_information['company_core_values']) && empty($company_base_information['company_strategy_goals']) && empty($user_skills_data) && empty($areas_of_expertise) && empty($user_services_data) && empty($user_certifications_data) && empty($recordArr)){
		if($this->session->userdata('user') && $user[0]->user_id == $user_detail['user_id']){
			$no_data_msg =  $this->config->item('user_profile_page_information_tab_no_data_same_user_view');
		} else {
			$user_name = ($user_detail['account_type'] == USER_COMPANY_ACCOUNT_TYPE && $user_detail['is_authorized_physical_person'] == 'Y')?$user_detail['first_name'] . ' ' . $user_detail['last_name']:$user_detail['company_name'];
...
<div>
		...
		<div class="proDtls <?php echo $noBorder;?>">
			<div class="pDtls">
				...
				<div class="usrTab Ppink_section">
				   ...
				   <p><?php echo ($user_detail['account_type'] == USER_PERSONAL_ACCOUNT_TYPE) || ($user_detail['account_type'] == USER_COMPANY_ACCOUNT_TYPE && $user_detail['is_authorized_physical_person'] == 'Y')?$this->config->item('ca_app_user_profile_page_description'):$this->config->item('ca_user_profile_page_description'); ?></p>
					</div>
					<div class="descTxt default_user_description desktop-secreen">
						...
						<p id="desktop_moreD" class="moreD">
							<?php echo $desktop_restdescription;?><button onclick="showMoreDescription('desktop')"><?php echo $this->config->item('show_less_txt'); ?></button></p>
					</div>
					<div class="descTxt default_user_description ipad-screen">
						...
						<p id="tablet_moreD" class="moreD">
							<?php echo $tablet_restdescription;?><button onclick="showMoreDescription('tablet')"><?php echo $this->config->item('show_less_txt'); ?></button></p>
					</div>
					<div class="descTxt default_user_description mobile-screen">
						...
						?>
						<p id="mobile_lessD">
						<?php echo $mobile_description; ?><?php if($mobile_cnt==1) {?><span id="mobile_dotsD"></span><button onclick="showMoreDescription('mobile')"><?php echo $this->config->item('show_more_txt'); ?></button><?php } ?></p>
						<p id="mobile_moreD" class="moreD">
							<?php echo $mobile_restdescription ;?><button onclick="showMoreDescription('mobile')"><?php echo $this->config->item('show_less_txt'); ?></button></p>
					</div>
				</div>
				...
				<?php
					if(!empty($company_base_information) && !empty($company_base_information['company_vision'])) {
				?>
				<!-- Our Vision Start -->
				<div class="usrTab Pred_section">
					<div class="bagTAg Pred">
						<p><?php echo ($user_detail['account_type'] == USER_PERSONAL_ACCOUNT_TYPE) || ($user_detail['account_type'] == USER_COMPANY_ACCOUNT_TYPE && $user_detail['is_authorized_physical_person'] == 'Y')?$this->config->item('ca_app_user_profile_page_our_vision_label_txt'):$this->config->item('ca_user_profile_page_our_vision_label_txt'); ?></p>
					</div>
					<div class="descTxt default_user_description desktop-secreen">
						<?php
							$desktop_cnt            =	0;
							$desktop_descLeng	=	strlen($company_base_information['company_vision']);
							if($desktop_descLeng <= $this->config->item('ca_user_profile_company_vision_display_minimum_length_character_limit_desktop')) {
								$desktop_description	= nl2br(htmlspecialchars($company_base_information['company_vision'], ENT_QUOTES));
							} else {
							$desktop_description	= character_limiter(nl2br($company_base_information['company_vision']),$this->config->item('ca_user_profile_company_vision_display_minimum_length_character_limit_desktop'));
								$desktop_restdescription = nl2br(htmlspecialchars($company_base_information['company_vision'], ENT_QUOTES));
								$desktop_cnt = 1;
							}
						?>
						<p id="company_vision_desktop_lessD">
						  <?php echo $desktop_description; ?><?php if($desktop_cnt==1) {?><span id="company_vision_desktop_dotsD"></span><button onclick="showMoreDescription('company_vision_desktop')"><?php echo $this->config->item('show_more_txt'); ?></button>
							<?php } ?></p>
						<p id="company_vision_desktop_moreD" class="moreD">
							<?php echo $desktop_restdescription;?><button onclick="showMoreDescription('company_vision_desktop')"><?php echo $this->config->item('show_less_txt'); ?></button></p>
					</div>
					<div class="descTxt default_user_description ipad-screen">
						<?php
							$tablet_cnt            =	0;
							$tablet_descLeng	=	strlen($company_base_information['company_vision']);
							if($tablet_descLeng <= $this->config->item('ca_user_profile_company_vision_display_minimum_length_character_limit_tablet')) {
								$tablet_description	= nl2br(htmlspecialchars($company_base_information['company_vision'], ENT_QUOTES));
							} else {
								$tablet_description	= character_limiter(nl2br($company_base_information['company_vision']),$this->config->item('ca_user_profile_company_vision_display_minimum_length_character_limit_tablet'));
								$tablet_restdescription = nl2br(htmlspecialchars($company_base_information['company_vision'], ENT_QUOTES));
								$tablet_cnt = 1;
							}
						?>
						<p id="company_vision_tablet_lessD">
							<?php echo $tablet_description; ?><?php if($tablet_cnt==1) {?><span id="company_vision_tablet_dotsD"></span><button onclick="showMoreDescription('company_vision_tablet')"><?php echo $this->config->item('show_more_txt'); ?></button>
							<?php } ?></p>
						<p id="company_vision_tablet_moreD" class="moreD">
							<?php echo $tablet_restdescription;?><button onclick="showMoreDescription('company_vision_tablet')"><?php echo $this->config->item('show_less_txt'); ?></button></p>
					</div>
					<div class="descTxt default_user_description mobile-screen">
						<?php
							$mobile_cnt            =	0;
							$mobile_descLeng	=	strlen($company_base_information['company_vision']);
							if($mobile_descLeng <= $this->config->item('ca_user_profile_company_vision_display_minimum_length_character_limit_mobile')) {
								$mobile_description	= nl2br(htmlspecialchars($company_base_information['company_vision'], ENT_QUOTES));
							} else {
								$mobile_description	= character_limiter(nl2br($company_base_information['company_vision']),$this->config->item('ca_user_profile_company_vision_display_minimum_length_character_limit_mobile'));
								$mobile_restdescription = nl2br(htmlspecialchars($company_base_information['company_vision'], ENT_QUOTES));
								$mobile_cnt = 1;
							}
						?>
						<p id="company_vision_mobile_lessD">
						<?php echo $mobile_description; ?><?php if($mobile_cnt==1) {?><span id="company_vision_mobile_dotsD"></span><button onclick="showMoreDescription('company_vision_mobile')"><?php echo $this->config->item('show_more_txt'); ?></button><?php } ?></p>
						<p id="company_vision_mobile_moreD" class="moreD">
							<?php echo $mobile_restdescription ;?><button onclick="showMoreDescription('company_vision_mobile')"><?php echo $this->config->item('show_less_txt'); ?></button></p>
					</div>
				</div>
				<div class="userHeightAdjust"></div>
				<!-- Our Vision End -->
				...
				?>
				<?php
					if(!empty($company_base_information) && !empty($company_base_information['company_mission'])) {
				?>
				<!-- Our Mission Start -->
				<div class="usrTab Pyellow_section">
					<div class="bagTAg Pyellow">
						<p><?php echo ($user_detail['account_type'] == USER_PERSONAL_ACCOUNT_TYPE) || ($user_detail['account_type'] == USER_COMPANY_ACCOUNT_TYPE && $user_detail['is_authorized_physical_person'] == 'Y')?$this->config->item('ca_app_user_profile_page_our_mission_label_txt'):$this->config->item('ca_user_profile_page_our_mission_label_txt'); ?></p>
					</div>
					<div class="descTxt default_user_description desktop-secreen">
						<?php
							$desktop_cnt            =	0;
							$desktop_descLeng	=	strlen($company_base_information['company_mission']);
							if($desktop_descLeng <= $this->config->item('ca_user_profile_company_mission_display_minimum_length_character_limit_desktop')) {
								$desktop_description	= nl2br(htmlspecialchars($company_base_information['company_mission'], ENT_QUOTES));
							} else {
								$desktop_description	= character_limiter(nl2br($company_base_information['company_mission']),$this->config->item('ca_user_profile_company_mission_display_minimum_length_character_limit_desktop'));
								$desktop_restdescription = nl2br(htmlspecialchars($company_base_information['company_mission'], ENT_QUOTES));
								$desktop_cnt = 1;
							}
						?>
						<p id="company_mission_desktop_lessD">
						  <?php echo $desktop_description; ?><?php if($desktop_cnt==1) {?><span id="company_mission_desktop_dotsD"></span><button onclick="showMoreDescription('company_mission_desktop')"><?php echo $this->config->item('show_more_txt'); ?></button>
							<?php } ?></p>
						<p id="company_mission_desktop_moreD" class="moreD">
							<?php echo $desktop_restdescription;?><button onclick="showMoreDescription('company_mission_desktop')"><?php echo $this->config->item('show_less_txt'); ?></button></p>
					</div>
					<div class="descTxt default_user_description ipad-screen">
						<?php
							$tablet_cnt            =	0;
							$tablet_descLeng	=	strlen($company_base_information['company_mission']);
							if($tablet_descLeng <= $this->config->item('ca_user_profile_company_mission_display_minimum_length_character_limit_tablet')) {
								$tablet_description	= nl2br(htmlspecialchars($company_base_information['company_mission'], ENT_QUOTES));
							} else {
								$tablet_description	= character_limiter(nl2br($company_base_information['company_mission']),$this->config->item('ca_user_profile_company_mission_display_minimum_length_character_limit_tablet'));
								$tablet_restdescription = nl2br(htmlspecialchars($company_base_information['company_mission'], ENT_QUOTES));
								$tablet_cnt = 1;
							}
						?>
						<p id="company_mission_tablet_lessD">
							<?php echo $tablet_description; ?><?php if($tablet_cnt==1) {?><span id="company_mission_tablet_dotsD"></span><button onclick="showMoreDescription('company_mission_tablet')"><?php echo $this->config->item('show_more_txt'); ?></button>
							<?php } ?></p>
						<p id="company_mission_tablet_moreD" class="moreD">
							<?php echo $tablet_restdescription;?><button onclick="showMoreDescription('company_mission_tablet')"><?php echo $this->config->item('show_less_txt'); ?></button></p>
					</div>
					<div class="descTxt default_user_description mobile-screen">
						<?php
							$mobile_cnt            =	0;
							$mobile_descLeng	=	strlen($company_base_information['company_mission']);
							if($mobile_descLeng <= $this->config->item('ca_user_profile_company_mission_display_minimum_length_character_limit_mobile')) {
								$mobile_description	= nl2br(htmlspecialchars($company_base_information['company_mission'], ENT_QUOTES));
							} else {
								$mobile_description	= character_limiter(nl2br($company_base_information['company_mission']),$this->config->item('ca_user_profile_company_mission_display_minimum_length_character_limit_mobile'));
								$mobile_restdescription = nl2br(htmlspecialchars($company_base_information['company_mission'], ENT_QUOTES));
								$mobile_cnt = 1;
							}
						?>
						<p id="company_mission_mobile_lessD">
						<?php echo $mobile_description; ?><?php if($mobile_cnt==1) {?><span id="company_mission_mobile_dotsD"></span><button onclick="showMoreDescription('company_mission_mobile')"><?php echo $this->config->item('show_more_txt'); ?></button><?php } ?></p>
						<p id="company_mission_mobile_moreD" class="moreD">
							<?php echo $mobile_restdescription ;?><button onclick="showMoreDescription('company_mission_mobile')"><?php echo $this->config->item('show_less_txt'); ?></button></p>
					</div>
				</div>
				<div class="userHeightAdjust"></div>
				<!-- Our Mission End -->
				...
				?>
				<?php
					if(!empty($company_base_information) && !empty($company_base_information['company_core_values'])) {
				?>
				<!-- Core Values Start -->
				<div class="usrTab Pseasaw_section">
					<div class="bagTAg Pseasaw">
						<p><?php echo ($user_detail['account_type'] == USER_PERSONAL_ACCOUNT_TYPE) || ($user_detail['account_type'] == USER_COMPANY_ACCOUNT_TYPE && $user_detail['is_authorized_physical_person'] == 'Y')?$this->config->item('ca_app_user_profile_page_core_values_label_txt'):$this->config->item('ca_user_profile_page_core_values_label_txt'); ?></p>
					</div>
					<div class="descTxt default_user_description desktop-secreen">
						<?php
							$desktop_cnt            =	0;
							$desktop_descLeng	=	strlen($company_base_information['company_core_values']);
							if($desktop_descLeng <= $this->config->item('ca_user_profile_company_core_values_display_minimum_length_character_limit_desktop')) {
								$desktop_description	= nl2br(htmlspecialchars($company_base_information['company_core_values'], ENT_QUOTES));
							} else {
								$desktop_description	= character_limiter(nl2br($company_base_information['company_core_values']),$this->config->item('ca_user_profile_company_core_values_display_minimum_length_character_limit_desktop'));
								$desktop_restdescription = nl2br(htmlspecialchars($company_base_information['company_core_values'], ENT_QUOTES));
								$desktop_cnt = 1;
							}
						?>
						<p id="company_core_desktop_lessD">
						  <?php echo $desktop_description; ?><?php if($desktop_cnt==1) {?><span id="company_core_desktop_dotsD"></span><button onclick="showMoreDescription('company_core_desktop')"><?php echo $this->config->item('show_more_txt'); ?></button>
							<?php } ?></p>
						<p id="company_core_desktop_moreD" class="moreD">
							<?php echo $desktop_restdescription;?><button onclick="showMoreDescription('company_core_desktop')"><?php echo $this->config->item('show_less_txt'); ?></button></p>
					</div>
					<div class="descTxt default_user_description ipad-screen">
						<?php
							$tablet_cnt            =	0;
							$tablet_descLeng	=	strlen($company_base_information['company_core_values']);
							if($tablet_descLeng <= $this->config->item('ca_user_profile_company_core_values_display_minimum_length_character_limit_tablet')) {
								$tablet_description	= nl2br(htmlspecialchars($company_base_information['company_core_values'], ENT_QUOTES));
							} else {
								$tablet_description	= character_limiter(nl2br($company_base_information['company_core_values']),$this->config->item('ca_user_profile_company_core_values_display_minimum_length_character_limit_tablet'));
								$tablet_restdescription = nl2br(htmlspecialchars($company_base_information['company_core_values'], ENT_QUOTES));
								$tablet_cnt = 1;
							}
						?>
						<p id="company_core_tablet_lessD">
							<?php echo $tablet_description; ?><?php if($tablet_cnt==1) {?><span id="company_core_tablet_dotsD"></span><button onclick="showMoreDescription('company_core_tablet')"><?php echo $this->config->item('show_more_txt'); ?></button>
							<?php } ?></p>
						<p id="company_core_tablet_moreD" class="moreD">
							<?php echo $tablet_restdescription;?><button onclick="showMoreDescription('company_core_tablet')"><?php echo $this->config->item('show_less_txt'); ?></button></p>
					</div>
					<div class="descTxt default_user_description mobile-screen">
						<?php
							$mobile_cnt            =	0;
							$mobile_descLeng	=	strlen($company_base_information['company_core_values']);
							if($mobile_descLeng <= $this->config->item('ca_user_profile_company_core_values_display_minimum_length_character_limit_mobile')) {
								$mobile_description	= nl2br(htmlspecialchars($company_base_information['company_core_values'], ENT_QUOTES));
							} else {
								$mobile_description	= character_limiter(nl2br($company_base_information['company_core_values']),$this->config->item('ca_user_profile_company_core_values_display_minimum_length_character_limit_mobile'));
								$mobile_restdescription = nl2br(htmlspecialchars($company_base_information['company_core_values'], ENT_QUOTES));
								$mobile_cnt = 1;
							}
						?>
						<p id="company_core_mobile_lessD">
						<?php echo $mobile_description; ?><?php if($mobile_cnt==1) {?><span id="company_core_mobile_dotsD"></span><button onclick="showMoreDescription('company_core_mobile')"><?php echo $this->config->item('show_more_txt'); ?></button><?php } ?></p>
						<p id="company_core_mobile_moreD" class="moreD">
							<?php echo $mobile_restdescription ;?><button onclick="showMoreDescription('company_core_mobile')"><?php echo $this->config->item('show_less_txt'); ?></button></p>
					</div>
				</div>
				<div class="userHeightAdjust"></div>
				<!-- Core Values End -->
				...
				?>
				<?php
					if(!empty($company_base_information) && !empty($company_base_information['company_strategy_goals'])) {
				?>
				<!-- Strategy and Goals Start -->
				<div class="usrTab Plightcherry_section">
					<div class="bagTAg Plightcherry">
						<p><?php echo ($user_detail['account_type'] == USER_PERSONAL_ACCOUNT_TYPE) || ($user_detail['account_type'] == USER_COMPANY_ACCOUNT_TYPE && $user_detail['is_authorized_physical_person'] == 'Y')?$this->config->item('ca_app_user_profile_page_strategy_goals_label_txt'):$this->config->item('ca_user_profile_page_strategy_goals_label_txt'); ?></p>
					</div>
					<div class="descTxt default_user_description desktop-secreen">
						<?php
							$desktop_cnt            =	0;
							$desktop_descLeng	=	strlen($company_base_information['company_strategy_goals']);
							if($desktop_descLeng <= $this->config->item('ca_user_profile_company_strategy_goals_display_minimum_length_character_limit_desktop')) {
								$desktop_description	= nl2br(htmlspecialchars($company_base_information['company_strategy_goals'], ENT_QUOTES));
							} else {
								$desktop_description	= character_limiter(nl2br($company_base_information['company_strategy_goals']),$this->config->item('ca_user_profile_company_strategy_goals_display_minimum_length_character_limit_desktop'));
								$desktop_restdescription = nl2br(htmlspecialchars($company_base_information['company_strategy_goals'], ENT_QUOTES));
								$desktop_cnt = 1;
							}
						?>
						<p id="company_goals_desktop_lessD">
						  <?php echo $desktop_description; ?><?php if($desktop_cnt==1) {?><span id="company_goals_desktop_dotsD"></span><button onclick="showMoreDescription('company_goals_desktop')"><?php echo $this->config->item('show_more_txt'); ?></button>
							<?php } ?></p>
						<p id="company_goals_desktop_moreD" class="moreD">
							<?php echo $desktop_restdescription;?><button onclick="showMoreDescription('company_goals_desktop')"><?php echo $this->config->item('show_less_txt'); ?></button></p>
					</div>
					<div class="descTxt default_user_description ipad-screen">
						<?php
							$tablet_cnt            =	0;
							$tablet_descLeng	=	strlen($company_base_information['company_strategy_goals']);
							if($tablet_descLeng <= $this->config->item('ca_user_profile_company_strategy_goals_display_minimum_length_character_limit_tablet')) {
								$tablet_description	= nl2br(htmlspecialchars($company_base_information['company_strategy_goals'], ENT_QUOTES));
							} else {
								$tablet_description	= character_limiter(nl2br($company_base_information['company_strategy_goals']),$this->config->item('ca_user_profile_company_strategy_goals_display_minimum_length_character_limit_tablet'));
								$tablet_restdescription = nl2br(htmlspecialchars($company_base_information['company_strategy_goals'], ENT_QUOTES));
								$tablet_cnt = 1;
							}
						?>
						<p id="company_goals_tablet_lessD">
							<?php echo $tablet_description; ?><?php if($tablet_cnt==1) {?><span id="company_goals_tablet_dotsD"></span><button onclick="showMoreDescription('company_goals_tablet')"><?php echo $this->config->item('show_more_txt'); ?></button>
							<?php } ?></p>
						<p id="company_goals_tablet_moreD" class="moreD">
							<?php echo $tablet_restdescription;?><button onclick="showMoreDescription('company_goals_tablet')"><?php echo $this->config->item('show_less_txt'); ?></button></p>
					</div>
					<div class="descTxt default_user_description mobile-screen">
						<?php
							$mobile_cnt            =	0;
							$mobile_descLeng	=	strlen($company_base_information['company_strategy_goals']);
							if($mobile_descLeng <= $this->config->item('ca_user_profile_company_strategy_goals_display_minimum_length_character_limit_mobile')) {
								$mobile_description	= nl2br(htmlspecialchars($company_base_information['company_strategy_goals'], ENT_QUOTES));
							} else {
								$mobile_description	= character_limiter(nl2br($company_base_information['company_strategy_goals']),$this->config->item('ca_user_profile_company_strategy_goals_display_minimum_length_character_limit_mobile'));
								$mobile_restdescription = nl2br(htmlspecialchars($company_base_information['company_strategy_goals'], ENT_QUOTES));
								$mobile_cnt = 1;
							}
						?>
						<p id="company_goals_mobile_lessD">
						<?php echo $mobile_description; ?><?php if($mobile_cnt==1) {?><span id="company_goals_mobile_dotsD"></span><button onclick="showMoreDescription('company_goals_mobile')"><?php echo $this->config->item('show_more_txt'); ?></button><?php } ?></p>
						<p id="company_goals_mobile_moreD" class="moreD">
							<?php echo $mobile_restdescription ;?><button onclick="showMoreDescription('company_goals_mobile')"><?php echo $this->config->item('show_less_txt'); ?></button></p>
					</div>
				</div>
				<div class="userHeightAdjust"></div>
				<?php
				...
				?>
				<!-- Strategy and Goals End -->
				<!-- Areas of Expertise Start -->
				<?php if(!empty($recordArr)) { ?>
				<div class="usrTab Pred_section">
					<div class="bagTAg Pred">
					<p><?php echo ($user_detail['account_type'] == USER_PERSONAL_ACCOUNT_TYPE) || ($user_detail['account_type'] == USER_COMPANY_ACCOUNT_TYPE && $user_detail['is_authorized_physical_person'] == 'Y')?$this->config->item('ca_app_user_profile_page_areas_of_expertise'):$this->config->item('ca_user_profile_page_areas_of_expertise'); ?></p>
					</div>
					<div class="aoExpt">
					   ...
					   foreach ($recordArr as $catKey=>$catArr) { 
						$m++;   
						if($m == $this->config->item('user_profile_page_maximum_area_of_expertise_show')+1) { echo '<input type="hidden" class="moreCat" value="1"><input type="hidden" class="rCat" value="'.$remainingCat.'"><section id="catDiv" class="chkSameLine" style="display:none">'; }   
						?>
				...
				<div class="usrTab Predpink_section">
					<div class="bagTAg Predpink">
						<p><?php echo ($user_detail['account_type'] == USER_PERSONAL_ACCOUNT_TYPE) || ($user_detail['account_type'] == USER_COMPANY_ACCOUNT_TYPE && $user_detail['is_authorized_physical_person'] == 'Y')?$this->config->item('ca_app_user_profile_page_services_provided_txt'):$this->config->item('ca_user_profile_page_services_provided_txt');  ?></p>
					</div>
			...
			<!-- Skills Start -->
				...
				<div class="usrTab PlightGreen_section">
					<div class="bagTAg PlightGreen">
						<p><?php echo $user_detail['is_authorized_physical_person'] == 'Y' ? $this->config->item('ca_app_user_profile_page_skills_txt') : $this->config->item('ca_user_profile_page_skills_txt');  ?></p>
					</div>
					<div class="fontSize0">
						<?php
						 $m = 0;
				...
				?>
					<div class="usrTab Pyellow_section">
						<div class="bagTAg Pyellow">
							<p><?php echo $this->config->item('ca_app_user_profile_page_work_experience') ?></p>
						</div>
						<?php
							 $m = 0;
							...
							<div class="wkExp default_bottom_border <?php echo $work_experience_last_record_class_remove_border_bottom; ?>">
								...
								<div class="etDate"><?php  /* $this->config->item('personal_account_work_experience_section_from')." ".$calendar_months[$work_experience_value['position_from_month']]." ".$work_experience_value['position_from_year']; ?><?php 
								...
								echo ($user_detail['is_authorized_physical_person'] == 'Y')?$this->config->item('company_account_app_work_experience_section_from')." ".$calendar_months[$work_experience_value['position_from_month']]." ":$this->config->item('personal_account_work_experience_section_from')." ".$calendar_months[$work_experience_value['position_from_month']]." ";
								echo $work_experience_value['position_from_year']." "; 
								if($work_experience_value['position_still_work'] == 0){	
									echo ($user_detail['is_authorized_physical_person'] == 'Y')?$this->config->item('company_account_app_work_experience_section_to')." ":$this->config->item('personal_account_work_experience_section_to')." ";
								...
								?></div><div class="default_user_description desktop-secreen">
									<?php
										...
										$desktop_descLeng	=	strlen($work_experience_value['position_description']); 
										/* echo $this->config->item('user_profile_work_experience_section_comments_display_minimum_length_character_limit_desktop'); */ 
					...
					<div class="usrTab Pseasaw_section">
						<div class="bagTAg Pseasaw">
							<p><?php echo  $this->config->item('ca_app_user_profile_page_education_training') ?></p>
						</div>
						<?php
						$m = 0;	
						...
						<div class="wkExp default_bottom_border <?php echo $education_training_last_record_class_remove_border_bottom; ?>">
							...
							<div class="etDate retrieved_section"><?php echo ($user_detail['is_authorized_physical_person'] == 'Y')?$this->config->item('company_account_app_education_section_graduated_in')." ":$this->config->item('personal_account_education_section_graduated_in')." "; 
					...
					<div class="usrTab Plightcherry_section">
						<div class="bagTAg Plightcherry">
							<p><?php echo $this->config->item('ca_app_user_profile_page_spoken_languages') ?></p>
						</div>
						<?php  
						...
						<div class="mTongue">
							<label>
								<span><?php echo $this->config->item('ca_app_user_profile_page_mother_tongue'); ?></span><small><?php echo $language_name['language']; ?></small>
							</label>
						</div>
						<?php } ?>
						<?php
						...
						<div class="othLan">
							...
							if(count($user_spoken_languages_data) > 1){
								echo $this->config->item('ca_app_user_profile_page_spoken_languages_txt_plural');
							}else{
								echo $this->config->item('ca_app_user_profile_page_spoken_languages_txt_singular');
							}?></span></p>
						</div>
						<?php 
						$m = 0;
						...
						<div class="pSkills">
							<div class="row">
								...
								<div class="col-md-9 col-sm-9 col-12 fontSize0 skillLanguage">
									<label><i class="far fa-thumbs-up"></i><b><?php echo $this->config->item('ca_app_profile_management_spoken_foreign_languages_section_title_understanding'); ?></b><?php echo $spoken_language_value['understanding']; ?></label>
									<label><i class="fa fa-bullhorn" aria-hidden="true"></i><b><?php echo $this->config->item('ca_app_profile_management_spoken_foreign_languages_section_title_speaking'); ?></b><?php echo $spoken_language_value['speaking']; ?></label>
									<label><i class="fa fa-pencil-square-o" aria-hidden="true"></i><b><?php echo $this->config->item('ca_app_profile_management_spoken_foreign_languages_section_title_writing'); ?></b><?php echo $spoken_language_value['writing']; ?></label>
								</div>
							</div>
						</div>
						<?php
						...
						<div class="row">
							<div class="col-md-12 col-sm-12 col-12">
								<div class="psLevel">
									<label><?php echo $this->config->item('ca_app_user_profile_page_spoken_languages_levels_description_msg'); ?></label>
								</div>
							</div>
				...
				<div class="usrTab Plightblue_section">
					<div class="bagTAg Plightblue">
						<p><?php echo  ($user_detail['account_type'] == USER_PERSONAL_ACCOUNT_TYPE) || ($user_detail['account_type'] == USER_COMPANY_ACCOUNT_TYPE && $user_detail['is_authorized_physical_person'] == 'Y')?$this->config->item('ca_app_user_profile_page_certifications'):$this->config->item('ca_user_profile_page_certifications'); ?></p>
					</div>
					<div class="cerDtls">
						<?php
						$m = 0;
						...
						?>
							<span class="default_bottom_border <?php echo $certifications_last_record_class_remove_border_bottom; ?> user_profile_page_certificates">
								<div class="certiText"><span class="certiSection"><b class="default_black_bold"><?php echo htmlspecialchars($certifications_value['certification_name'], ENT_QUOTES); ?></b></span><span class="acquiredOn"><small class="default_black_regular"><?php echo $this->config->item('ca_user_certifications_section_acquired_on'); ?></small><b class="default_black_bold"><?php echo $calendar_months [$certifications_value['certification_month']]; ?> <?php echo $certifications_value['certification_year']; ?></b></span><div class="clearfix"></div></div>
								<?php
	...
	<div class="userLeft_Section">
		...
		<div>
		<?php 
			if(!empty($company_base_information) && ($user_detail['is_authorized_physical_person'] == 'N' && (!empty($company_base_information['company_year_founded']) || !empty($company_base_information['company_size']))) || $user_detail['is_authorized_physical_person'] == 'Y') {
				if(($user_detail['account_type'] == USER_PERSONAL_ACCOUNT_TYPE) || ($user_detail['account_type'] == USER_COMPANY_ACCOUNT_TYPE && $user_detail['is_authorized_physical_person'] == 'Y')) {
					$company_profile_heading = $this->config->item('ca_app_user_profile_page_company_profile_heading');
				} else {
					$company_profile_heading = $this->config->item('ca_user_profile_page_company_profile_heading');
				}
		?>
		<div class="srcTyp">
			<h4><?php echo  $company_profile_heading; ?><?php 
				if($user_detail['is_authorized_physical_person'] == 'Y'){ ?><label><?php echo $this->config->item('account_management_account_details_company_app_account_type_txt'); ?></label><?php } ?></h4>
			<?php
				...
				if(!empty($company_base_information) && !empty($company_base_information['company_year_founded']) && ($company_base_information['company_year_founded'] >= $st_yr && $company_base_information['company_year_founded'] <= $en_yr)) {
			?>
			<div class="staPro">				
				<label><?php echo ($user_detail['account_type'] == USER_PERSONAL_ACCOUNT_TYPE) || ($user_detail['account_type'] == USER_COMPANY_ACCOUNT_TYPE && $user_detail['is_authorized_physical_person'] == 'Y')?$this->config->item('ca_app_user_profile_page_company_founded_label_txt'):$this->config->item('ca_user_profile_page_company_founded_label_txt'); ?></label>
				<label><?php echo $company_base_information['company_year_founded']; ?></label>
				<div class="clearfix"></div>
			</div>
			<?php 
				}
			...
			if(!empty($company_base_information) && !empty($company_base_information['company_size']) && in_array($company_base_information['company_size'], $company_size_dropdown)) {
			?>
			<div class="staProComSize">				
				<label class="staCompany_size_title"><?php echo ($user_detail['account_type'] == USER_PERSONAL_ACCOUNT_TYPE) || ($user_detail['account_type'] == USER_COMPANY_ACCOUNT_TYPE && $user_detail['is_authorized_physical_person'] == 'Y')?$this->config->item('ca_app_user_profile_page_company_size_label_txt'):$this->config->item('ca_user_profile_page_company_size_label_txt'); ?></label>
				<?php 
					echo '<label class="staCompany_size_two">'.$company_base_information['company_size'].'</label>';
				?>
				<div class="clearfix"></div>
			</div>
			<?php
		...
		?><div class="srcTyp">
				...
				<div class="staPro user_rightSection_bottombdr">				
					<label class="projectText"><?php echo $this->config->item('user_profile_page_sp_statistics_hourly_rate'); ?></label>
					<label class="projectCost"><?php  echo str_replace(".00","",number_format($user_detail['hourly_rate'], 0, '', ' ')).' '.CURRENCY.$this->config->item('profile_management_user_hourly_rate_per_hour') ;?></label>
					<div class="clearfix"></div>
				</div>
				<?php } ?>
				<div class="staPro">				
					<label><?php echo $this->config->item('user_profile_page_sp_statistics_total_won_projects'); ?></label>
					<label><?php echo $sp_won_projects_count; ?></label>
					<div class="clearfix"></div>
				</div>
				<div class="staPro">				
					<label><?php echo $this->config->item('user_profile_page_sp_statistics_projects_in_progress'); ?></label>
					<label><?php echo $sp_in_progress_projects_count; ?></label>
					<div class="clearfix"></div>
				</div>
				<div class="staPro">				
					<label><?php echo $this->config->item('user_profile_page_sp_statistics_total_completed_projects'); ?></label>
					<label><?php echo $sp_completed_projects_count; ?></label>
					<div class="clearfix"></div>
				</div>
				<div class="staPro">				
					<label><?php echo $this->config->item('user_profile_page_sp_statistics_projects_completed_via_portal'); ?></label>
					<label><?php echo $sp_completed_projects_count_via_portal; ?></label>
					<div class="clearfix"></div>
				</div>
			...
			?>
				<?php if($address_detail_exists) { ?><div class="srcTypOL">
					<h4><?php echo $company_location_heading; ?></h4>
					<?php echo $address_details; ?></div><?php } ?><div class="srcTypO">
				<h4><?php echo $user_detail['is_authorized_physical_person'] == 'Y' ? $this->config->item('ca_app_user_profile_page_informations') : $this->config->item('ca_user_profile_page_informations'); ?></h4>
				<div class="staProO">				
					<label><i class="fa fa-clock-o default_green" aria-hidden="true"></i><?php echo $this->config->item('user_profile_page_user_member_since'); ?> <?php echo date(DATE_FORMAT,strtotime($user_detail['account_validation_date']));?></label>
					<div class="clearfix"></div>
				</div>
				<div class="staProO">				
					<label><i class="fa fa-sign-in default_red" aria-hidden="true"></i><?php echo $this->config->item('user_profile_page_user_last_login'); ?> <?php echo date(DATE_TIME_FORMAT,strtotime($user_detail['latest_login_date']));?></label>
					<div class="clearfix"></div>
				</div>
				<div class="staProO">				
					<?php 
					...
					?>
					<label><i class="fa fa-eye" aria-hidden="true"></i><?php echo $this->config->item('user_profile_page_user_profile_viewed'); ?> <?php echo $view_txt;?></label>
					<div class="clearfix"></div>
				</div>
				<?php 
