...
$config['find_professionals_starting_position_to_search'] = 2; // this variable is used to look into db when user entered this many character into textbox
...
$config['find_professionals_maximum_categories_show'] = 12;

$config['find_professionals_loader_progressbar_display_time'] = 3500;

$config['find_professionals_email_share_user_descripition_character_limit'] = 350;
