...
$config['escrow_description_minimum_length_character_limit_escrow_form'] = 5; //minimum limit of character of escrow description on escrow form
//escrow _description_minimum_length_character_limit_ create_escrow _form
...
//escrow _description_maximum_length_character_limit_ create_escrow _form

$config['escrow_amount_length_character_limit_escrow_form'] = 15; //maximum limit of character of escrow amount on escrow form
//escrow _amount_length_character_limit_ create_escrow _form
...
$config['project_details_page_escrow_description_characters_min_length_validation_project_escrow_form_message'] = 'your escrow description must be at least '.$config['escrow_description_minimum_length_character_limit_escrow_form'].' characters';

$config['project_details_page_escrow_description_characters_min_length_validation_fulltime_project_escrow_form_message'] = 'your escrow description must be at least '.$config['escrow_description_minimum_length_character_limit_escrow_form'].' characters';
...
$config['project_detail_page_escrow_number_of_pagination_links'] = 2;
