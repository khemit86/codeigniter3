...
$config['fulltime_project_dispute_female_sp_accept_counter_offer_email_subject_sent_to_employer'] = 'fulltime:FEMale:dispute case {dispute_reference_id} resolved by {sp_first_name_last_name}';
...
$config['fulltime_project_dispute_email_subject_sent_to_employee_dispute_decided_admin_arbitration_employee_winner'] = 'Fulltime:dispute case {dispute_reference_id} Closed By Admin';
...
$config['project_dispute_email_subject_sent_to_po_dispute_decided_admin_arbitration_male__employee_winner'] = 'Fulltime:dispute case {dispute_reference_id} Closed By Admin[Male SP]';
