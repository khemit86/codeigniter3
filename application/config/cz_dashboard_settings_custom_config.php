...
$config['send_feedback_popup_minimum_length_character_limit'] = 10;

$config['send_feedback_popup_minimum_length_error_message'] = 'zpráva musí mít alespoň '.$config['send_feedback_popup_minimum_length_character_limit'].' znaků';

$config['send_feedback_popup_word_minimum_length_error_message'] = 'zpráva musí mít alespoň '.$config['send_feedback_popup_minimum_length_character_limit'].' znaků a '.$config['send_feedback_popup_minimum_length_word_limit'].' slov';
...
$config['send_feedback_popup_attachment_maximum_size_validation_message'] = "soubor, který chcete nahrát má velikost {file_size_mb} MB a tím překračuje maximální povolenou velikost souboru ".$config['send_feedback_popup_attachment_maximum_size_limit']." MB";
...
$config['send_feedback_popup_allowed_number_of_files_validation_message'] = "přiložit je možné maximálně ".$config['send_feedback_popup_maximum_allowed_number_of_attachments']." soubory";
...
$config['dashboard_latest_projects_section_number_of_displayed_listings'] = 0; //on live server to be used 3
...
/* $config['user_profile_completion_parameters_tracking_options_value'] = array('email_confirmation' => 50,'facebook_connection' => 5,'linkedin_connection' => 5); */
