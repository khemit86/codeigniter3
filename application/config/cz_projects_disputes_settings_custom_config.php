...
$config['user_projects_disputes_management_page_active_disputes_listing_limit'] = 5;
$config['user_projects_disputes_management_page_closed_disputes_listing_limit'] = 5;
$config['user_projects_disputes_management_page_number_of_pagination_links'] = 1;
...
$config['minimum_required_disputed_fixed_budget_project_value_for_admin_arbitration'] = 10000; 
$config['minimum_required_disputed_hourly_rate_based_project_value_for_admin_arbitration'] = 12000; 
$config['minimum_required_disputed_fulltime_project_value_for_admin_arbitration'] = 15000; 
