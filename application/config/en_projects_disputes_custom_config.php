...
$config['projects_left_nav_projects_disputes'] = 'Disputes Management';

//page heading
$config['projects_disputes_page_headline_title'] = 'Projects Disputes Management';
//Meta Tag
$config['projects_disputes_page_title_meta_tag'] = '{user_first_name_last_name_or_company_name} | Projects Disputes';
//Description Meta Tag
$config['projects_disputes_page_description_meta_tag'] = '{user_first_name_last_name_or_company_name} | Projects Disputes';

$config['project_detail_page_payment_tab_open_dispute_txt'] = 'open dispute';
//project owner checkbox
$config['projects_disputes_page_project_owner'] = 'Project Owner';
...
$config['projects_disputes_page_checkbox_service_provider'] = 'Service provider';
...
//$config['user_projects_disputes_management_page_start_new_disputes_listing_limit'] = 10;

$config['user_projects_disputes_management_page_paging_url'] = 'page';

$config['user_projects_disputes_management_page_dispute_id_txt'] = 'Dispute Id:';
$config['user_projects_disputes_management_page_project_title_txt'] = 'Project Title:';
$config['user_projects_disputes_management_page_fulltime_project_title_txt'] = 'Fulltime Project Title:';
$config['user_projects_disputes_management_page_disputed_amount_txt'] = 'Disputed Amount:';
$config['user_projects_disputes_management_page_total_related_service_fees_txt'] = 'Total related service fees:';
$config['user_projects_disputes_management_page_dispute_initiated_by_txt'] = 'Dispute initiated by:';
$config['user_projects_disputes_management_page_dispute_start_date'] = 'Dispute Start date:';
$config['user_projects_disputes_management_page_dispute_close_date'] = 'Dispute Close date:';
$config['user_projects_disputes_management_page_negotiation_stage_end_date_txt'] = 'Negotiation stage end date:';
$config['user_projects_disputes_management_page_admin_moderation_phase_txt'] = 'Admin Moderation';
$config['user_projects_disputes_management_page_user_negotiation_phase_txt'] = 'Negotiation stage';

$config['user_projects_disputes_management_page_select_project_dropdown_option_txt'] = 'Select Project';
$config['user_projects_disputes_management_page_open_dispute_button_txt'] = 'Open Dispute';

// Initial view message when no active/closed disputes exists
$config['user_projects_disputes_management_page_no_active_disputes_message'] = "You do not have any active disputes";
$config['user_projects_disputes_management_page_no_closed_disputes_message'] = "You do not have any closed disputes";


// Initial view message for po view on dispute page (new dispute tab)
$config['user_projects_disputes_management_page_no_published_project_message_po_view'] = "PO:You do not currently have any published project";
$config['user_projects_disputes_management_page_no_financial_activity_on_published_project_message_po_view_singular'] = "PO:You do not any finalcial activity on project";
$config['user_projects_disputes_management_page_no_financial_activity_on_published_projects_message_po_view_plural'] = "PO:You do not any finalcial activity on projects";

// Initial view message for sp view on dispute page (new dispute tab)
$config['user_projects_disputes_management_page_no_project_message_sp_view'] = "SP:You do not currently have any activity on any project.";
$config['user_projects_disputes_management_page_no_financial_activity_on_project_message_sp_view_singular'] = "SP:You do not currently have any financial activity on any project";
$config['user_projects_disputes_management_page_no_financial_activity_on_projects_message_sp_view_plural'] = "SP:You do not currently have any financial activity on any projects";
...
// for fulltime project
$config['fulltime_project_dispute_details_page_user_try_to_upload_attachment_when_negotiation_time_expired_dispute_on_autodecided_dispute'] = "Fulltime:You cannot upload attachment.Project negotiation time expired. The dispute has been automatically closed.";
$config['fulltime_project_dispute_details_page_user_try_to_upload_attachment_when_negotiation_time_expired_dispute_on_admin_arbitration'] = "Fulltime:You cannot upload attachment.Project negotiation time expired. The dispute is under admin review..";
$config['fulltime_project_dispute_details_page_user_try_to_upload_attchment_on_already_closed_dispute'] = "Fulltime:You cannot upload attachment.Project dispute already closed";
...
// For Fulltime project
$config['fulltime_project_dispute_details_page_dispute_initiation_phase_rules_heading'] = 'FULLTIME-Dispute Initiation Phase - Disputes Rules';
...
// modal title
$config['project_dispute_details_page_dispute_initiate_confirmation_project_modal_title'] = 'Initiate the Dispute';
$config['fulltime_project_dispute_details_page_dispute_initiate_confirmation_project_modal_title'] = 'Fulltime:Initiate the Dispute';

//modal body
$config['project_dispute_details_page_dispute_initiate_confirmation_project_modal_body'] = 'Are you sure you want to initiate dispute on project <a href="#" class="default_popup_blue_text">{project_title}</a> against user <a href="{user_profile_url_link}" class="default_popup_blue_text" href="#">{user_first_name_last_name_or_company_name}</a>, for <span class="touch_line_break">{project_disputed_amount}</span>?';

$config['fulltime_project_dispute_details_page_dispute_initiate_confirmation_project_modal_body'] = 'Fulltime:Are you sure you want to initiate dispute on project <a href="#" class="default_popup_blue_text">{fulltime_project_title}</a> against user <a href="{user_profile_url_link}" class="default_popup_blue_text" href="#">{user_first_name_last_name_or_company_name}</a>, for <span class="touch_line_break">{fulltime_project_disputed_amount}</span>?';

// modal button
$config['project_dispute_details_page_dispute_initiate_confirmation_project_modal_dispute_initiate_btn_txt'] = 'Initiate the dispute';
$config['fulltime_project_dispute_details_page_dispute_initiate_confirmation_project_modal_dispute_initiate_btn_txt'] = 'Initiate the dispute fulltime';
...
// For fulltime project
$config['fulltime_project_dispute_details_page_dispute_cancel_confirmation_project_modal_dispute_cancel_btn_txt'] = 'fulltime Cancel Dispute';
