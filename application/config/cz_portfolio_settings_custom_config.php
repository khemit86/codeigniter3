...
$config['user_portfolio_section_description_characters_minimum_length_characters_limit'] = 3;
...
$config['user_portfolio_section_portfolio_description_characters_minimum_length_validation_message'] = 'povinné je minimálně '.$config['user_portfolio_section_description_characters_minimum_length_characters_limit'].' znaků';

$config['user_portfolio_section_portfolio_description_characters_words_minimum_length_validation_message'] = 'popis portofolia musí obsahovat alespoň '.$config['user_portfolio_section_description_characters_minimum_length_characters_limit'].' znaky a '.$config['user_portfolio_section_description_minimum_length_words_limit'].' slov';
...
// variabil for TAGS
$config['user_portfolio_section_tags_characters_minimum_length_validation_message'] = 'povinné je minimálně '.$config['user_portfolio_section_tags_characters_minimum_length_characters_limit'].' znaků';

$config['user_portfolio_section_listing_limit'] = 5;
$config['user_portfolio_section_number_of_pagination_links'] = 1;
...
$config['user_portfolio_page_section_free_membership_subscriber_number_portfolio_slots_allowed'] = 5;
...
$config['user_portfolio_page_gold_membership_subscriber_number_tags_allowed_per_portfolio_slot'] = 3;

$config['user_portfolio_page_free_membership_subscriber_number_images_allowed_per_portfolio_slot'] = 5;
$config['user_portfolio_page_gold_membership_subscriber_number_images_allowed_per_portfolio_slot'] = 15;


$config['user_portfolio_section_free_membership_subscriber_number_images_allowed_per_portfolio_slots_exceeded_error_message'] = "nahrát lze maximálně ".$config['user_portfolio_page_free_membership_subscriber_number_images_allowed_per_portfolio_slot']." souborů";

$config['user_portfolio_section_gold_membership_subscriber_number_images_allowed_per_portfolio_slots_exceeded_error_message'] = "nahrát lze maximálně ".$config['user_portfolio_page_gold_membership_subscriber_number_images_allowed_per_portfolio_slot']." souborů";



$config['portfolio_id_min_number'] = 100;// minimun number from where portfolio id will start
$config['portfolio_id_max_number'] = 99999999999;// maximum number where portfolio id will be end
// so the portfolio id will be exists on above number

$config['user_portfolio_section_portfolio_image_maximum_size_limit'] = 3;//(Size in MB) size of image allowed on portfolio create popup page

$config['user_portfolio_section_portfolio_image_exceeded_maximum_allowed_size_error_message'] = "soubor, který chcete nahrát má velikost {file_size_mb} MB, a tím překračuje maximální povolenou velikost souboru ".$config['user_portfolio_section_portfolio_image_maximum_size_limit']." MB";

$config['user_portfolio_standalone_page_cover_picture_upload_max_size_allocation'] = 5;

$config['user_portfolio_standalone_page_cover_picture_upload_max_size_validation_message'] = "Maximální možná velikost obrázku pro nahrátí je ".$config['user_portfolio_standalone_page_cover_picture_upload_max_size_allocation']." MB.";

$config['email_share_user_portfolio_standalone_page_description_character_limit'] = 350;
