...
$config['gold_subscribers_max_number_of_favorite_employers_subscriptions'] = 500; //to be implemented later - 0 means unlimited

// variable to manage favourite employers limit
$config['favorite_employers_listing_limit_per_page'] = 10;
/**
 ...
 * 
*/
$config['favorite_employers_number_of_pagination_links'] = 1;
