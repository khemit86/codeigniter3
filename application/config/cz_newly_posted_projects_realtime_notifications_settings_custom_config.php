...
// variable to manage newly posted projects notification listing limit per page
$config['newly_posted_projects_realtime_notification_listing_limit_per_page'] = 10;

//This variable is used to show projects notification feeds page pagination links*/
$config['newly_posted_projects_realtime_notification_number_of_pagination_links'] = 1;
...
$config['newly_posted_projects_realtime_notification_limit'] = 10;
...
$config['newly_posted_projects_email_share_project_description_character_limit'] = 350;
