...
FacebookSession::setDefaultApplication( '262028517184991','a8eac43be3b35cc7380f9b96b0250cb8' );
...
if ( isset( $session ) ) {
  ...
  $graphObject = $response->getGraphObject();
    ...
    //$locations = $location->getProperty('name');
    //$add = explode(", ", $locations);
    ...
    //$_SESSION['FB_CITY']   =  $add[0];
    //$_SESSION['FB_COUNTRY']   =  $add[1];
       
    /* ---- header location after session ----*/
    header("Location: ".base_url('login/check_login'));
